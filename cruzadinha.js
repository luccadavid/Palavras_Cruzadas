function verificar(Numero) {
    ...
    if (num == 1) {
        ...
        if (DUALCORE == 'DUALCORE') {
            ...
            // MUDANDO COR DA BOX \\
            letra1P1.style = "border: solid #4169E1;"
            letra2P1.style = "border: solid #4169E1;"
            letra3P1.style = "border: solid #4169E1;"
            letra4P1.style = "border: solid #4169E1;"
            letra4P1.style = "border: solid #4169E1;"
            letra5P1.style = "border: solid #4169E1;"
            letra6P1.style = "border: solid #4169E1;"
            letra7P1.style = "border: solid #4169E1;"
            letra8P1.style = "border: solid #4169E1;"
        ...
        var EPROM = (letra8P7.value + letra1P13.value + letra2P13.value + letra3P13.value + letra4P13.value).toUpperCase();
        if (EPROM == 'EPROM') {
            letra8P7.disabled = true;
            letra1P13.disabled = true;
            letra2P13.disabled = true;
            letra3P13.disabled = true;
            letra4P13.disabled = true;


            letra8P7.style = 'border: solid #4169E1;';
            letra1P13.style = 'border: solid #4169E1;';
            letra2P13.style = 'border: solid #4169E1;';
            letra3P13.style = 'border: solid #4169E1;';
            letra4P13.style = 'border: solid #4169E1;';
        }
    }   // FIM PALAVRA 13 \\

    else if (num == 14) {
        var ROM = (letra2P13.value + letra1P14.value + letra2P14.value).toUpperCase();
        if (ROM == 'ROM') {
            letra2P13.disabled = true;
            letra1P14.disabled = true;
            letra2P14.disabled = true;

            letra2P13.style = 'border: solid #4169E1;';
            letra1P14.style = 'border: solid #4169E1;';
            letra2P14.style = 'border: solid #4169E1;';
  
        }
    }   // FIM PALAVRA 14 \\

    else if (num == 15) {
        var RAM = (letra7P3.value + letra1P15.value + letra2P15.value).toUpperCase();
        if (RAM == 'RAM') {
            letra7P3.disabled = true;
            letra1P15.disabled = true;
            letra2P15.disabled = true;

            letra7P3.style = 'border: solid #4169E1;';
            letra1P15.style = 'border: solid #4169E1;';
            letra2P15.style = 'border: solid #4169E1;';
        }
    }   // FIM PALAVRA 15 \\
}